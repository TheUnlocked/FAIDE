...
class FAILangLexer extends Lexer_1.Lexer {
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(FAILangLexer._ATN, this);
    }
    get vocabulary() {
        return FAILangLexer.VOCABULARY;
    }
    get grammarFileName() { return "FAILang.g4"; }
    get ruleNames() { return FAILangLexer.ruleNames; }
    get serializedATN() { return FAILangLexer._serializedATN; }
    get modeNames() { return FAILangLexer.modeNames; }
    static get _ATN() {
        if (!FAILangLexer.__ATN) {
            FAILangLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(FAILangLexer._serializedATN));
        }
        return FAILangLexer.__ATN;
    }
}
FAILangLexer.PLUS = 1;
FAILangLexer.SUBTRACT = 2;
FAILangLexer.MULTIPLY = 3;
FAILangLexer.DIVIDE = 4;
FAILangLexer.MODULO = 5;
FAILangLexer.EXPONENT = 6;
FAILangLexer.EQ = 7;
FAILangLexer.NE = 8;
FAILangLexer.R_ARR = 9;
FAILangLexer.L_ARR = 10;
FAILangLexer.GE = 11;
FAILangLexer.LE = 12;
FAILangLexer.NOT = 13;
FAILangLexer.L_PAREN = 14;
FAILangLexer.R_PAREN = 15;
FAILangLexer.L_CURL = 16;
FAILangLexer.R_CURL = 17;
FAILangLexer.L_BRAC = 18;
FAILangLexer.R_BRAC = 19;
FAILangLexer.COMMA = 20;
FAILangLexer.COLON = 21;
FAILangLexer.SEMI_COLON = 22;
FAILangLexer.VERT_LINE = 23;
FAILangLexer.ELIPSIS = 24;
FAILangLexer.ARROW = 25;
FAILangLexer.NUMBER = 26;
FAILangLexer.STRING = 27;
FAILangLexer.BOOLEAN = 28;
FAILangLexer.VOID = 29;
FAILangLexer.LAMBDA = 30;
FAILangLexer.UPDATE = 31;
FAILangLexer.MEMO = 32;
FAILangLexer.IF = 33;
FAILangLexer.OTHERWISE = 34;
FAILangLexer.NAME = 35;
FAILangLexer.COMMENT = 36;
FAILangLexer.MULTILINE_COMMENT = 37;
FAILangLexer.WS = 38;
FAILangLexer.modeNames = [
    "DEFAULT_MODE"
];
FAILangLexer.ruleNames = [
...
FAILangLexer._LITERAL_NAMES = [
    undefined, "'+'", "'-'", "'*'", "'/'", "'%'", "'^'", "'='", "'~='", "'>'",
    "'<'", "'>='", "'<='", "'~'", "'('", "')'", "'{'", "'}'", "'['", "']'",
    "','", "':'", "';'", "'|'", undefined, "'->'", undefined, undefined, undefined,
    "'void'", "'lambda'", "'update'", "'memo'", "'if'", "'otherwise'"
];
FAILangLexer._SYMBOLIC_NAMES = [
...
FAILangLexer.VOCABULARY = new VocabularyImpl_1.VocabularyImpl(FAILangLexer._LITERAL_NAMES, FAILangLexer._SYMBOLIC_NAMES, []);
FAILangLexer._serializedATN = "\x03\uAF6F\u8320\u479D\uB75C\u4880\u1605\u191C\uAB37\x02(\u0140\b\x01" +
...
], FAILangLexer.prototype, "vocabulary", null);
__decorate([
    Decorators_2.Override
], FAILangLexer.prototype, "grammarFileName", null);
__decorate([
    Decorators_2.Override
], FAILangLexer.prototype, "ruleNames", null);
__decorate([
    Decorators_2.Override
], FAILangLexer.prototype, "serializedATN", null);
__decorate([
    Decorators_2.Override
], FAILangLexer.prototype, "modeNames", null);
exports.FAILangLexer = FAILangLexer;
//# sourceMappingURL=FAILangLexer.js.map